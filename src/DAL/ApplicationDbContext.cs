...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<QuestionCategoryTree> questionCategoryTree { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            /// my added
            // builder.Entity<Question>().ToTable($"App{nameof(this.question)}");
            // builder.Entity<QuestionOption>().ToTable($"App{nameof(this.questionOption)}");
        }
        ...
        private void UpdateAuditEntities()
        {
            ...
            foreach (var entry in modifiedEntries)
            {
                ...
                // var userId = UsernManager.AuthenticationManager.AuthenticationResponseGrant.Identity.GetUserId();

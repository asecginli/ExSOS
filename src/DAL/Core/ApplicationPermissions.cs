...
namespace DAL.Core
{
    public static class ApplicationPermissions
    {
        ...
        //* Question Banks *//
        public const string questionPermissionGroupName = "Questions Permissions";
        public static ApplicationPermission VievQuestion = new ApplicationPermission("Manage Questions", "questions.manage", questionPermissionGroupName, "Permission to create, delete and modify other questions from questionBanks details");
        private static ApplicationPermission WriteQuestion = new ApplicationPermission("Viev Questions", "questions.view", questionPermissionGroupName, "Permission to view other questions from questionBanks details");

...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    corporationWebUrl = "www.intapptech.com";
    appTitle = "ExSOS";
    appVersion = "1.0.0";
    appWebUrl = "www.intapptech.com/exsos";
    ...
    constructor(storageManager: LocalStoreManager, private toastyService: ToastyService, private toastyConfig: ToastyConfig,
        ...
        translationService.addLanguages(["tr", "en", "fr", "de", "ar", "ko", "pt"]);
        translationService.setDefaultLanguage('tr');
